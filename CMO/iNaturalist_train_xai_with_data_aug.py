...
args['epochs'] = 100
args['start_cut_mix'] = -1 # start data augmentation after 25th epoch
...
'''
args['cut_mix'] = 'CMO_XAI' # 'CMO' or 'CMO_XAI' or 'CMO_XAI_MASK' or 'CMO_OBJ_DET'
...
def getCountourList(threshold, saliencys):
    ...
    #create a list of bounding box coordinates, for each image in the batch, shape 16 by 4
